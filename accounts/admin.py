...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        (_("اطلاعات شخصی"), {"fields": ("name",)}),
        (_("دسترسی‌ها"), {"fields": ("is_active", "is_admin", "is_superuser")}),
...
class ProfileAdmin(admin.ModelAdmin):
    ...
    search_fields = ("user__email", "user__name", "phone_number", "location", "bio")
    list_per_page = 20
    ...
    fieldsets = (
        (None, {"fields": ("user",)}),
        (_("اطلاعات تماس"), {"fields": ("phone_number", "website", "location")}),
        (_("اطلاعات شخصی"), {"fields": ("bio", "birth_date")}),
        (_("مدیریت رسانه"), {"fields": ("avatar", "avatar_preview")}),
